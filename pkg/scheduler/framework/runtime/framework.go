...
func (f *frameworkImpl) RunPlacementGeneratorPlugins(ctx context.Context, state fwk.PodGroupCycleState, podGroup fwk.PodGroupInfo, initialParents []*fwk.PlacementInfo) (placements []*fwk.PlacementInfo, status *fwk.Status) {
	startTime := time.Now()
	defer func() {
